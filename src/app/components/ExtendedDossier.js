  ...
  },
  {
    ...
    content: (
      <div className={styles.dossierContentBlock}>
        ...
        <p className={styles.dossierBodyText}>
          Served successively as Acting Head of Compensation Department, Deputy Director (1999), Director of Compensation (Jan 2004), and Commission Secretary (equivalent to Federal Permanent Secretary), before his landmark appointment by the President Commander-in-Chief as:
        </p>
